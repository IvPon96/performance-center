# v 1.0 (Based on the previous app.py)
...
def load_and_process():
    ...
    try:
        ...
        # Merge Primario y Secundario (Fallback)
        df = df.merge(dim[['Master_Email', 'Full_Name', 'production_floor']], 
                      left_on='email', right_on='Master_Email', how='left')
        
      # --- Paso 2: UNIÓN POR NOMBRE (Respaldo por bajas) ---
      # Se crea una versión DIM optimizada para buscar por nombre
