...
# CSS para métricas y contenedores
st.markdown("""
    <style>
...
if data_pack:
    ...
    if not data.empty:
        ...
        if not df_final.empty:
            ...
            # --- FILA 3: LOG DETALLADO (CON INTENTOS DIARIOS) ---
